...
import br.org.furb.compilador.util.ViewUtil;
...
public class PrincipalView extends JFrame {
	...
	private void btnEquipeEvt() {
		textAreaMensagens.setText("André Vinícius Bampi \n"
				...
				+ "(mais informações do compilador no arquivo leia-me.txt)");
	}
	...
	public PrincipalView() {
		...
		textAreaCodigo = new JTextPane(ViewUtil.getDefaultStypeDocument());
		...
		lines.setFont(ViewUtil.LINE_NUMBER_FONT);
		lines.setForeground(new Color(130, 130, 130));
	 ...
	 * @return
	 */
	private DocumentListener listnerLineNumbers(final JTextPane jta,
